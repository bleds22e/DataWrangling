...
Check to see if `TREE_SURVEYS.txt` is in your workspace. If not, [download `TREE_SURVEYS.txt`](https://ndownloader.figshare.com/files/5629536). Use `read_tsv` from the `readr` package to read in the data using the following command:
