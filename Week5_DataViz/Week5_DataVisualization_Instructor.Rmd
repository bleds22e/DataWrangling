...
This happens because the default `position` for `geom_histogram` is `"stacked"`, which stacks the bars on top of one another and, therefore, makes a stacked histogram.
...
Close, but not quite there! To see all of the treatments, we need to make the columns partially transparent.
