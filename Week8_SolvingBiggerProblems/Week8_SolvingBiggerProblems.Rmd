...
Let's start by breaking down the problem. Then, we can add one piece at
a time
...
-   Look at the current state of the environment. This gives you a
    current snapshot of what is going on - Talk through the code
-   [Rubber duck
...
First, copy the code into a new code chunk below. Spend a few minutes
working through this code chunk to debug it. Utilize some of the
strategies above.
