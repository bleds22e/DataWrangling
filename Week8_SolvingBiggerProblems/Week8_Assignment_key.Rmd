...
e. (Challenge, optional) Instead of excluding continent `EA` by name in your analysis (in
...
In this question, we are going to take some raw data and recreate a clean dataset. This is from the `palmerpenguins` R package, which has body size measurements from 3 species of Antarctic penguins from 2007-2009. 
First, we need to load in the package and take a look at the clean version of the data that we are trying to recreate.
```{r}
