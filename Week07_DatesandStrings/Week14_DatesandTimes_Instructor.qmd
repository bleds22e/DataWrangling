...
![Table from: <https://stat.ethz.ch/R-manual/R-devel/library/base/html/strptime.html>](images/common_r_date_formats.png){width="85%" fig-align="center"}
...
| Let's Practice: Work on Question 4d in the assignment.
