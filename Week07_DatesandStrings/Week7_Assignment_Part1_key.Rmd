...
During my PhD, I collected plant vouchers from the Portal Project that I eventually submitted to the UA Herbarium for identification. I also got DNA sequences for most of them (but not all). Read in that dataset by running the code chunk below.
