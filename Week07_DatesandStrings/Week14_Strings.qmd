...
Many of the tools we are covering in this class (especially joins, pivots, and strings) were integral to getting those datasets wrangled. Here is just one example of the type of dataset I was working with.
...
Finally, we could create a column for whether or not the sample was taken from below the surface ("DEEP").
