...
make_sp_time_series_plot <- function(data, genus_name, species_name){
...
make_sp_time_series_plot(combined, "Dipodomys", "merriami")
ggsave("output/Functions-portal-species-time-series-R-1.png")

make_sp_time_series_plot(combined, "Chaetodipus", "penicillatus")
