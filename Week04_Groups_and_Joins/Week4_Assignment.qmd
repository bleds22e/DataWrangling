...
In addition to the main data table on shrub dimensions (`shrub_dims`), Dr. Morales has two additional data tables. The first describes the manipulation for each experiment. The second provides information about the different sites.

Run the following code chunk to bring them into your environment.
