...
```{r}
# TO DO
# - add link to "tidyexplain" for joins (maybe include gifs?)
# - use a different dataset for joins either here or in homework
# - better explanation of binds vs joins
# - add info about in-class exercise with combining data (hands on)
```
