...
![](../images/ClearEnvironment.png){width="50%" fig-align="center"}
...
| `Tools` &rightarrow `Global Options` -\> `General` -\> `Save workspace to ~/.RData on exit` -\> `Never`

Uncheck `Restore .RData into workspace at startup`

![](../images/rstudio-workspace.png){width="50%" fig-align="center"}
...
If possible, we want to have all files associated with the project in one main folder. This main folder should be the RProject folder.
