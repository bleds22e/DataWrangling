...
-   `scripts` or `files` or `code`
    -   any files in the scripts folder (.R, .Rmd, or .qmd) should have relative file paths to read in and create files
...
-   For Quarto (and RMarkdown) files, the folder in which the file is located is the working directory.
