...
If possible, we want to have all files associated with the project in one main folder. This main folder should be the RStudio Project folder.
...
### File Paths in RMarkdown Files vs. Scripts
...
-   For R scripts, the R Project folder is the working directory, which is standard.
