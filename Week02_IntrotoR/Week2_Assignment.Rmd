...
At the end of this question, add a new code chunk (`Ctrl + Alt + I` or `Cmd + Opt + I`). In that code chunk, add additional lines of code come accomplish the following:
