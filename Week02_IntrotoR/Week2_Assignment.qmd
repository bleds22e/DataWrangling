...
[View Answer Key](Week2_Assignment_AnswerKey.html){.btn .btn-primary role="button"}
:::
...
At the end of this question, add a new code chunk (`Ctrl + Atl + I` or `Cmd + Opt + I`). In that code chunk, add additional lines of code come accomplish the following:
...
1.  Click the `Render` button up near the top of this document. This should produce a PDF file that shows up in the `Files` panel on the bottom-right of your screen. (*If you can't get your file to Knit to PDF, you can submit the .Rmd file instead.*)
