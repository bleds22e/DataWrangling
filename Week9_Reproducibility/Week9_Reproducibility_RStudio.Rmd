...
![](images/rstudio-project-1.png){width="50%"} ![](images/rstudio-project-2.png){width="50%"} ![](images/rstudio-project-3.png){width="50%"}
...
```{r}
write_csv(data, "data_clean/shrubs_modified.csv")
```

### Changing Projects

If you want to switch between projects, you can do so:
> `File` -\> `Recent Projects` or `Open Project`
...
![](images/project-based-directory-organization.jpg){width="50%"}
