...
a. Use this function to estimate the mass of a Sauropoda (`a = 214.44`, `b = 1.46`) that
   is 22 m long (by setting `a` and `b` when calling the function).
b. Use this function to estimate the mass of a dinosaur from an unknown taxonomic group that is 16m long.
...
First, load either the `tidyverse` or `ggplot`.
...
Save your plot as a .png file into the appropriate sub-directory.
...
count_data <- data.frame(state = state_vector,
                         site = site_vector,
                         count = count_vector,
                         area = area_vector)
count_data
