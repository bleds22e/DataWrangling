...
**Due Date**: Tuesday, Dec 9 at midnight MST
...
### 2. Review Code and Submit Comments via GitHub (75 points)

Provide **specific, respectful, and helpful** comments via GitHub. See the "Checklist" document for more detailed information.
...
In the `PeerCodeReview_Checklist_Reflection.qmd` file, complete the checklist and write 7-10 sentences summarizing your review experience:
...
Upload the rendered Word file to the "Peer Code Review" Assignment on D2L; if you are having issues rendering, submitting the `.qmd` file is perfectly fine.
...
| *Documentation Comments* | 15 | Reviewer comments on README quality and .qmd documentation. |
...
-   Confirm that:
    -   The *base* repository is your peer’s/the class organization's (e.g., `DataWrangling-Fall2025/project`).
...
-   Include the "3 actionable suggestions" from your review (and any other notes not included in the code).
...
If you and/or you peer want to have further discussion about any of the comments or suggestions, you can use the "Conversation" and "Files Changed" tabs.
