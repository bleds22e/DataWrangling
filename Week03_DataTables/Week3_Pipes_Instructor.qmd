...
You can think of the pipe as automatically sending the output from the first line into the next line as the input--specifically, it becomes the first *argument* in the next function.
