...
est_mass(24, "shrub", age = 2) # uses different equations for shrubs of different ages
est_mass(24, "shrub", age = 6)
est_mass(24, "grass")   # does not require the age argument because it does not apply to grass
```
...
When none of the conditions are meant, `case_when` will return `NA` by default.

If you want something else returned instead of `NA`, you can modify the `.default` argument.
