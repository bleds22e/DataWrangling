...
November 18 before class

::: {.content-visible when-format="html"}
[View Answer Key](Week12_Assignment_AnswerKey.html){.btn .btn-primary role="button"}
:::
...
### 2. If/Else Statements (20 points)

a.  Complete the following `if` statement so that if `age_class` is equal to "sapling" it sets the output, `y`, as 10.
...
b.  Complete the following `if` statement so that if `age_class` is equal to "sapling" it sets `y` as 10, and if `age_class` is equal to "seedling," `y` is set as 5.
...
c.  Complete the following `if` statement so that if `age_class` is equal to "sapling" it sets `y` as 10, if `age_class` is equal to "seedling" it sets `y` to 5, and if `age_class` is something else then it sets the value of `y` to 0.
...
### 3. If/Else Statements in Functions (20 points)
